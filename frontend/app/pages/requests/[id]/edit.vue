  ...
  <div class="max-w-4xl mx-auto space-y-6">
    <div class="mb-8">
      <div class="flex items-center gap-4 mb-6">
        <NuxtLink :to="`/requests/${route.params.id}`" class="p-2 rounded-lg hover:bg-gray-100 transition-colors">
        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            <h1 class="text-3xl font-bold text-gray-900">Редактирование заявки #{{ route.params.id }}</h1>
            <p class="mt-1 text-gray-600">Внесите необходимые изменения</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <form @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <div class="p-6 space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select v-model="form.priority" required class="input-field">
      ...
      <div class="card">
        ...
        <div class="p-6 space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select v-model="form.assigned_to" class="input-field">
                ...
                <option value="Козлова А.В.">Козлова А.В.</option>
              </select>
            </div>
          </div>
          ...
          <div>
            ...
            <div v-if="form.existingFiles && form.existingFiles.length > 0" class="mb-3 space-y-2">
              <div
              ...
              >
                <div class="flex items-center gap-2">
                  <Icon name="ri:file-line" class="text-gray-600" />
                ...
                >
                  <Icon name="ri:close-line" class="text-gray-600" />
                </button>
              </div>
            </div>
            ...
            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-primary-500 transition-colors cursor-pointer">
              ...
              <div @click="$refs.fileInput.click()">
                <Icon name="ri:upload-cloud-line" class="text-4xl text-gray-400 mx-auto mb-2" />
            ...
            <div v-if="form.newFiles.length > 0" class="mt-3 space-y-2">
              <div
              ...
              >
                <div class="flex items-center gap-2">
                  <Icon name="ri:file-add-line" class="text-blue-600" />
                  <span class="text-sm text-gray-900">{{ file.name }}</span>
                  <span class="text-xs text-gray-500">({{ formatFileSize(file.size) }})</span>
                  <span class="text-xs text-blue-600">Новый</span>
                </div>
                <button
                  type="button"
      ...
      <div class="flex items-center justify-between gap-4">
        <NuxtLink :to="`/requests/${route.params.id}`" class="btn btn-secondary">
