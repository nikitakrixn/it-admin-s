            ...
            >
                <div class="p-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div
                            class="h-12 w-12 rounded-lg bg-amber-100 flex items-center justify-center"
                        >
                            <Icon
                                name="ri:time-line"
            ...
            >
                <div class="p-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div
                            class="h-12 w-12 rounded-lg bg-red-100 flex items-center justify-center"
                        >
                            <Icon
...
const stats = computed(() => {
    return {
        ...
        in_progress: requests.value.filter((r) => r.status === "in_progress")
            .length,
        completed: requests.value.filter((r) => r.status === "completed")
            .length,
        cancelled: requests.value.filter((r) => r.status === "cancelled")
            .length,
    };
});
