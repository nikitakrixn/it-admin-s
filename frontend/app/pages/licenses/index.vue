    ...
    <div class="space-y-6">
        <div class="mb-8">
            <div class="flex items-center gap-4">
                <div
                    class="h-16 w-16 rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-700 flex items-center justify-center shadow-lg"
                >
                    <Icon
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="card">
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 mb-1">Истекшие</p>
                        ...
                        >
                            ...
                            <td class="px-4 py-4">
                                <span
                                    :class="[
                                        'badge',
                                        getLicenseStatus(license).color,
                                    ]"
                                    >{{ getLicenseStatus(license).label }}</span
                                >
                            </td>
                        </tr>
                    </tbody>
...
const filteredLicenses = computed(() => {
    ...
    if (searchQuery.value) {
        ...
        filtered = filtered.filter((l) =>
            l.software.toLowerCase().includes(query),
        );
    }
    return filtered;
});
...
const getLicenseStatus = (license: any) => {
    ...
    if (daysLeft < 0)
        return { label: "Истекла", color: "bg-red-100 text-red-800" };
    if (daysLeft < 30)
        return { label: "Истекает", color: "bg-amber-100 text-amber-800" };
    return { label: "Активна", color: "bg-green-100 text-green-800" };
};
</script>
