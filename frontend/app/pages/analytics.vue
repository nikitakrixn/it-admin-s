        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <div
                        class="h-16 w-16 rounded-2xl gradient-secondary flex items-center justify-center shadow-lg"
                    >
                        <Icon
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-gray-600">
                            Детальная статистика и отчеты системы
                        </p>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="p-6">
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <div
                            class="flex h-14 w-14 items-center justify-center rounded-xl bg-amber-100 text-amber-600"
                        >
            ...
            <div class="card">
                ...
                <div class="p-6">
                    <div class="text-center mb-6">
                        <div
                            class="inline-flex items-center justify-center h-32 w-32 rounded-full bg-gradient-to-br from-primary-500 to-primary-700 text-white mb-4 shadow-lg"
                        >
                            <div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        >
                            <td class="px-6 py-4">
                                <div
                                    class="flex items-center justify-center w-8 h-8 rounded-lg bg-gray-100 text-gray-700 font-semibold text-sm"
                                >
                                    {{ index + 1 }}
                                </div>
                            </td>
            ...
            <div class="card">
                ...
                <div class="p-6 space-y-3">
                    ...
                    >
                        <div class="flex items-center gap-3">
                            <Icon
                                name="ri:checkbox-multiple-line"
                                class="text-xl text-purple-600"
                            />
                            <span class="text-sm font-medium text-gray-900"
                                >Закрыто за день</span
                            >
                        </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-7 gap-2">
                        ...
                        >
                            <div class="mb-2">
                                <div
                                    class="h-24 bg-gray-100 rounded-lg flex items-end justify-center p-2"
                                >
                                    <div
                                        :style="{
...
const maxActivity = computed(() =>
    Math.max(...weekActivity.value.map((d) => d.value)),
);

const downloadReport = () => {
    toast.success(
        "Отчет формируется. Загрузка начнется через несколько секунд.",
    );
};
</script>
