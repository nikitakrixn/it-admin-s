            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-gray-600">
                        Поиск и анализ устройств в локальной сети
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 card">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="space-y-3">
                        ...
                        >
                        <div
                            class="flex items-center gap-2 p-3 rounded-lg border border-gray-200 hover:border-primary-300 transition-colors cursor-pointer"
                        >
                            <input
                            ...
                            >
                                ...
                                <span class="text-gray-500 block text-xs"
                                    >Быстрое сканирование без проверки
                                    портов</span
                                >
                            </label>
                        </div>
            ...
            <div class="card">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div
                        v-else-if="foundDevices.length > 0"
                        class="text-center py-4"
                    >
                        <div
                            class="h-16 w-16 rounded-full bg-green-100 flex items-center justify-center mx-auto mb-3"
                        >
                            <Icon
                                name="ri:checkbox-circle-line"
                        ...
                        <p class="text-xs text-gray-500 mt-1">
                            Найдено {{ foundDevices.length }} устройств
                        </p>
                    </div>

                    <div v-else class="text-center py-4">
                        <div
                            class="h-16 w-16 rounded-full bg-gray-100 flex items-center justify-center mx-auto mb-3"
                        >
                            <Icon
                                name="ri:radar-line"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        >
                            ...
                            <td class="px-4 py-4">
                                <div
                                    v-if="device.ports && device.ports.length"
...
const startScan = async () => {
    ...
    currentScanIp.value = "";
    toast.success(
        `Сканирование завершено! Найдено ${foundDevices.value.length} устройств`,
    );
};
