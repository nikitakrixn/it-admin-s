      ...
      <div class="card">
        <div class="p-8">
          <div class="text-center mb-8">
            <div class="inline-flex h-16 w-16 items-center justify-center rounded-2xl gradient-secondary mb-4">
              <Icon name="ri:user-add-line" class="text-3xl text-white" />
            </div>
            <h1 class="text-2xl font-bold text-gray-900">Регистрация</h1>
            <p class="mt-2 text-sm text-gray-600">Создайте новый аккаунт</p>
          </div>
