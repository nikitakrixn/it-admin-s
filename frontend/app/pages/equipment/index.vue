        ...
        <div class="card">
            <div class="p-4">
                <div class="grid grid-cols-5 gap-4">
                    <div
                        class="p-3 cursor-pointer hover:bg-gray-50 rounded-lg"
    ...
    if (searchQuery.value) {
        ...
        filtered = filtered.filter(
            (e) =>
                ...
                e.inventory_number.toLowerCase().includes(query),
        );
    }
    return filtered;
});
