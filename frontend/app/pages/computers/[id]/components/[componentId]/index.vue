            ...
            <div class="flex items-center gap-4 mb-6">
                ...
                <div class="flex-1 flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <div
                            :class="[
                                ...
                                getComponentGradient(component.type),
                            ]"
                        >
                            <Icon
                    ...
                    <div class="flex items-center gap-2">
                        <NuxtLink
                            :to="`/computers/${route.params.id}/components/${route.params.componentId}/edit`"
...
const history = ref([
    {
        id: 1,
        action: "Компонент добавлен",
        icon: "ri:add-line",
        created_at: "15.01.2024 10:00",
    },
    {
        id: 2,
        action: "Обновлена информация",
        icon: "ri:edit-line",
