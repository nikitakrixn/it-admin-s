  ...
  <div class="max-w-3xl mx-auto space-y-6">
    <div class="mb-8">
      <div class="flex items-center gap-4 mb-6">
        <NuxtLink :to="`/computers/${route.params.id}/components/${route.params.componentId}`" class="p-2 rounded-lg hover:bg-gray-100 transition-colors">
        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            <h1 class="text-3xl font-bold text-gray-900">Редактирование компонента</h1>
    ...
    <form @submit.prevent="handleSubmit" class="space-y-6">
      <div class="card">
        ...
        <div class="p-6 space-y-4">
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">Тип компонента</label>
            <input :value="getComponentTypeLabel(form.type)" type="text" class="input-field" disabled />
          </div>
        ...
        <div class="p-6 space-y-4">
          <div class="grid grid-cols-2 gap-4">
            <div v-for="(value, key) in form.specs" :key="key">
              ...
              <input v-model="form.specs[key]" type="text" class="input-field" />
            </div>
          </div>
      ...
      <div class="flex items-center justify-between gap-4">
        <NuxtLink :to="`/computers/${route.params.id}/components/${route.params.componentId}`" class="btn btn-secondary">
...
const handleSubmit = async () => {
  try {
    ...
    router.push(`/computers/${route.params.id}/components/${route.params.componentId}`)
  } catch (error) {
