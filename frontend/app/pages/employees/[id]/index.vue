<template>
    <div class="space-y-6">
                ...
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex items-start gap-4">
                            <div
                                class="h-24 w-24 rounded-2xl gradient-primary flex items-center justify-center flex-shrink-0 shadow-lg"
                            >
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap items-center gap-2">
                                    ...
                                    <span
                                        ...
                                        class="badge bg-purple-100 text-purple-800 flex items-center gap-1"
                                    >
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="card">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        >
                            ...
                            <p
                                class="text-sm text-gray-900 font-medium flex items-center gap-2"
                            >
                                <Icon
                ...
                <div class="card">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div
                            v-else
                            class="pt-4 border-t border-gray-100 text-sm text-gray-400"
                        >
                            Телефон не указан
                        </div>
                    </div>
        ...
        <ConfirmModal
            ...
            :message="
                employee
                    ? `Вы уверены, что хотите удалить сотрудника ${employee.full_name}? Это действие нельзя будет отменить.`
                    : ''
            "
...
const {
    ...
    pending,
    error,
} = await useAsyncData(`employee-${employeeId.value}`, () =>
    fetchEmployee(employeeId.value),
);

useHead({
    title: employee.value
        ? `${employee.value.full_name} - Сотрудник`
        : "Сотрудник",
});
