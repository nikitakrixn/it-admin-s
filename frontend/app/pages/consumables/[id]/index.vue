                    ...
                    <div class="p-6">
                        <div class="space-y-3">
                            <div
                                ...
                                :key="movement.id"
                                class="flex items-center justify-between p-3 rounded-lg hover:bg-gray-100 transition-colors"
                            >
...
const movements = ref([
    {
        ...
        quantity: 10,
        notes: "Закупка",
        created_at: "01.12.2025 10:00",
    },
    {
        id: 2,
        type: "usage",
        quantity: -3,
        notes: "Замена в принтере офис 301",
        created_at: "05.12.2025 14:30",
    },
    {
        id: 3,
        type: "usage",
        quantity: -2,
        notes: "Замена в принтере офис 201",
        created_at: "08.12.2025 11:00",
    },
]);
...
const getStockStatus = () => {
    if (consumable.value.quantity === 0)
        return { label: "Нет в наличии", color: "bg-red-100 text-red-800" };
    if (consumable.value.quantity <= consumable.value.min_quantity)
