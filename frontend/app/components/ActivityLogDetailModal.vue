    ...
    <Teleport to="body">
        <Transition name="modal">
            <div v-if="show" class="fixed inset-0 z-[60] overflow-y-auto">
                ...
                >
                    <div
                        class="relative bg-white rounded-2xl shadow-2xl max-w-3xl w-full"
                    >
                        <div
                        ...
                        <div
                            v-if="log"
                            class="p-6 max-h-[70vh] overflow-y-auto scrollbar-thin"
                        >
                            <div class="space-y-6">
                                ...
                                >
                                    ...
                                    <div
                                        class="p-4 rounded-lg bg-green-50 border border-green-100"
                                    >
                                        <div
                                            class="flex items-center gap-2 mb-2"
                                        >
                                    ...
                                    <div
                                        class="p-4 rounded-lg bg-amber-50 border border-amber-100"
                                    >
                                        <div
                                            class="flex items-center gap-2 mb-2"
                                        >
                                ...
                                >
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        >
                                            ...
                                            >
                                                <div
                                                    class="flex-1 p-2 rounded bg-red-50 border border-red-200"
                                                >
                                                    <p
                                                ...
                                                />
                                                <div
                                                    class="flex-1 p-2 rounded bg-green-50 border border-green-200"
                                                >
                                                    <p
                                                        class="text-xs text-gray-500 mb-1"
                                                    >
