<template>
    ...
    >
                ...
                <div class="flex h-full flex-col">
                    ...
                    >
                        <div class="flex items-center gap-3">
                            <div
                                class="h-10 w-10 rounded-xl gradient-primary flex items-center justify-center"
                            >
                                <Icon
        ...
        <div class="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
            <div
                class="flex flex-col flex-1 bg-white border-r border-gray-200 shadow-sm"
            >
                <div
                    class="flex h-16 items-center px-6 border-b border-gray-200"
                >
                    <div class="flex items-center gap-3">
                        <div
                            class="h-10 w-10 rounded-xl gradient-primary flex items-center justify-center shadow-lg"
                        >
                            <Icon
                                name="ri:shield-check-line"
                                class="text-xl text-white"
        ...
        <div class="lg:pl-64">
            <header
                class="sticky top-0 z-40 flex h-16 items-center gap-4 border-b border-gray-200 bg-white/80 backdrop-blur-md px-4 shadow-sm lg:px-6"
            >
                <button
                ...
                <div class="flex flex-1 items-center justify-between gap-4">
                    ...
                    >
                        ...
                        <kbd
                            class="ml-auto px-2 py-1 text-xs bg-white rounded border border-gray-200"
                            >Ctrl K</kbd
                        >
                    </button>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        >
                            ...
                            />
                            <span
                                class="absolute top-1 right-1 h-2 w-2 rounded-full bg-red-500 animate-pulse"
                            />
                        </button>
                    </div>
                </div>
...
const toggleTheme = () => {
    ...
    toast.info(
        `Тема ${isDark.value ? "темная" : "светлая"} будет доступна в следующей версии`,
    );
};
